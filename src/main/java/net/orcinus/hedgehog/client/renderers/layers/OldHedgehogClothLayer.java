...
public class OldHedgehogClothLayer extends RenderLayer<HedgehogEntity, EntityModel<HedgehogEntity>> {
    ...
    public OldHedgehogClothLayer(OldHedgehogRenderer hedgehogRenderer, EntityModelSet modelSet) {
        super(hedgehogRenderer);
        this.model = new OldHedgehogModel<>(modelSet.bakeLayer(HedgehogModelLayers.OLD_HEDGEHOG_DECOR));
    }
